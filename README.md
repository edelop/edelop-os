...
To jest folder-starter, z którego zbudujesz WŁASNY system do ogarniania projektów, celów i codziennych spraw - nie klikając w żadnej aplikacji, tylko rozmawiając z AI. Twój asystent poprowadzi Cię przez onboarding krok po kroku: Ty mówisz, co masz na głowie, a system rośnie razem z Tobą. Na końcu masz własny **Edelop OS**: jeden widok na projekty, cele i codzienne sprawy - i system, który pamięta za Ciebie. Działa jak dźwignia: Ty myślisz o jednej rzeczy naraz, a system pilnuje dwudziestu.

To są zwykłe pliki tekstowe w zwykłym folderze. Nie wymagają żadnej aplikacji i zostają Twoje, nawet gdy zmienisz narzędzia albo asystenta.
...
Onboarding to około 5 dni po 20-40 minut dziennie. Nie musisz robić wszystkiego na raz - asystent pamięta, gdzie skończyliście, i za każdym razem podejmuje wątek.
